...
const Header = ({ type }) => {
  ...
  return (
    <div className='header'>
      <div className={type === "list" ? "overlay listMode" : "overlay"}></div>
      <video
        className={type === "list" ? "video listMode" : "video"}
        src={video}
        muted
        autoPlay
        loop
            ...
            <div className='headerSearch'>
              ...
              <div className='headerSearchItem'>
                ...
                <span
                  ...
                  adult .<span className='count'>{`${options.children}`}</span>
                  children .<span className='count'>{`${options.room}`}</span>
                  room
                </span>
                {openOptions && (
